...
import com.feyl.spring.aop.framework.Cglib2AopProxy;
import com.feyl.spring.aop.framework.JdkDynamicAopProxy;
...
public class ApiTest {
    ...
    public void test_aop() throws NoSuchMethodException {
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut("execution(* com.feyl.spring.test.bean.UserService.*(..))");
    ...
    public void test_dynamic() {
        ...
        // 测试调用
        System.out.println("测试结果：" + proxy_cglib.register("Spring"));
    }
